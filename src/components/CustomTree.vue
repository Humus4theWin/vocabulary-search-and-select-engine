    ...
    overrideSlotDefault({ node, path, tree }, original) {
      return (
        <div class="node-content">
          ...
          <button
            class="mrs fold-btn"
            onClick={() => tree.toggleFold(node, path)}
          >
            {node.$folded ? "+" : "-"}
          </button>
          {original()}
          <button class="mls">edit</button>
          <button class="mls" onClick={() => this.removeNodeByPath(path)}>
            remove
          </button>
          <button class="mls" onClick={() => this.hideNode(node)}>
            hidden
          </button>
        </div>
      );
      ...
      return (
        <div class="header">
          <div>
            ...
            <button onClick={this.showHidden} class="mls">
              show hidden
            </button>
          </div>
          <input
